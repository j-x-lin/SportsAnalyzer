...
// float l1_distance(descriptor a, descriptor b, int n)
// {
//     // TODO: return the correct number.
//     float dist = 0;
//     for (int i = 0; i < n; i++)
//     {
//         dist += fabs(a.data[i] - b.data[i]);
//     }
...
//         for (i = 0; i < bn; i++)
//         {
//             float d = l1_distance(a[j], b[i], b[i].n);
...
//     matrix xtp = matrix_mult_matrix(H, c);
//     double x_t = xtp.data[0][0];
//     double y_t = xtp.data[1][0];
//     double w_t = xtp.data[2][0];

//     point q = make_point(x_t/w_t, y_t/w_t);
//     return q;
// }
...
//     {
//         match curr = m[i];
//         point projection = project_point(H, curr.p);
//         if (point_distance(projection, curr.q) < thresh) {
//             m[i] = m[count];
//             m[count] = curr;
//             count++;
