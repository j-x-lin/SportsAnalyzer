...
identity_homography = lib.identity_homography
identity_homography.argtypes = []
identity_homography.restype = MATRIX

matrix_print = lib.matrix_print
matrix_print.argtypes = [MATRIX]
matrix_print.restype = None

matrix_make = lib.matrix_make
